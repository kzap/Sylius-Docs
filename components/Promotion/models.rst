...
The promotion rule is represented by a **Rule** instance. It has the following properties as default:
...
The promotion action is represented by an **Action** instance. It has the following properties as default:
